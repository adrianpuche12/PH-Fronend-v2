    ...
    <View style={styles.root}>
      ...
      <Modal visible={createModal} transparent animationType="fade" onRequestClose={() => setCreateModal(false)}>
        <View style={styles.overlay}>
          <ScrollView showsVerticalScrollIndicator={false} style={{ scrollbarWidth: 'none' } as any} contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center', padding: 16 }}>
